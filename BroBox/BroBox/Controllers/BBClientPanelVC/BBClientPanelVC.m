...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == BBClientPanelSectionInformations && (indexPath.row == BBClientPanelInformationRowCarrier || indexPath.row == BBClientPanelInformationRowReceiver)) {
